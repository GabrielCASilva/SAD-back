...
public class TarefaController {
    ...
    public ResponseEntity<List<Tarefa>> obterTarefasServidorPorPeriodo(
    ...
    public ResponseEntity<List<Tarefa>> obterTarefasSupervisorPorPeriodo(
    ...
    public ResponseEntity<List<Tarefa>> obterTarefasDaMetaNoPeriodo(
