...
public class Seeding implements Serializable, CommandLineRunner  {
	...
	public void run(String... args) throws Exception {
		...
		Funcionario f10 = new Funcionario("Ágatha Luana Almeida",      LocalDate.of(2001, 2, 22),  'F', 37572844618L, 20920250L, "Rua Conde de Bom Fim", 	  9827665L, "linkFoto", "agatha@gmail.com",   LocalDate.of(2022, 1, 10), "agatha",   "12345", SituacaoFuncionario.ATIVO, s04, c01);
