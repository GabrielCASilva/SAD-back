...
public class AvaliacaoExecutor implements Avaliacao{
	...
	public AvaliacaoExecutor(Funcionario funcionarioSuperior) {
	...
	public void obterTarefas() {
		//TODO 
		/* Verificar se tarefasServidor corresponde de fato com o q eu imagino
		 * */
		this.tarefasAvaliacao = this.funcionarioAlvo.getTarefasServidor();
	}
